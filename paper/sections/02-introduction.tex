...
The Collatz conjecture, attributed to Lothar Collatz around
1937~\cite{Collatz1937}, concerns the behaviour of the map
\[
...
Lagarias's surveys~\cite{Lagarias1985,Lagarias2010}, early analytic
bounds such as Crandall's~\cite{Crandall1978}, Eliahou's lower bound on
the length of hypothetical cycles~\cite{Eliahou1993}, and Tao's recent
almost-all result on Collatz orbits~\cite{Tao2022}. Representative
recent milestones directly relevant to our formulation :
